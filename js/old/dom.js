(function(){
	...
	storeUser.get().then(function(querySnapshot) {
		...
		//Name Header
		$("#titulo").html("Olá, " + getUser[0].nomeUser);
		window.name = getUser[0].nomeUser;
		console.log("E-mail do cara: " + getUser[0].emailUser + " :)")
		console.log("Senha do cara: " + getUser[0].senhaUser + " :)")
